...
主にMultiChannelControllerでマルチチャンネルJSONをエクスポートする際に利用します。
...
主にMultiChannelControllerでマルチチャンネルJSONをインポートする際に利用します。
...
### [MultiChannelController] 変数・Public関数一覧

* [変数](#multichannelcontroller-変数)
...
* [Public関数](#multichannelcontroller-public関数)
  * [SplitMML()](#splitmml)
...
### [MultiChannelController] Public関数
