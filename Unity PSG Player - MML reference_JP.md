...
* [**データ定義**](#データ定義)
  ...
  * [**M\<num\>{\<delay\>,\<deapth\>,\<speed\>}**　LFO定義](#mnumdelaydepthspeedlfo定義)
* [**コメント**](#コメント)
  * [**/\* ～ \*/**　範囲コメント](#--範囲コメント)
...
* [**チャンネル間同期**](#チャンネル間同期)
  * [**!（エクスクラメーションマーク）**　チャンネルシンクマーカー](#エクスクラメーションマークチャンネルシンクマーカー)
...
LFOの内容については[LFO定義](#mnumdelaydepthspeedlfo定義)を参照してください。  
...
#### **M\<num\>{\<delay\>,\<depth\>,\<speed\>}**　LFO定義

* パラメーター
  * \<num\>　*LFO番号[1～127]（省略不可）*
  * \<delay\>　*LFOがかかるまでの遅延[0～255]（省略時：0）*
  * \<depth\>　*音程の上下幅[0～255]（省略時：0）*
...
マルチチャンネルでの演奏時に、同期させるタイミングを指定します。  
同期させたい全チャンネルの同タイミングに記述する必要があります。  
使用にあたってはいくつか注意点があるので、[マニュアル](Unity%20PSG%20Player%20-%20manual_JP.md)を参照してください。  
